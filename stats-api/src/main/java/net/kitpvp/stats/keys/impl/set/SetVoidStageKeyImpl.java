...
public class SetVoidStageKeyImpl<X> extends VoidStageKeyImpl<Set<X>, SetSStatsKey<X>> implements SetSStageKey<X> {
    ...
    public SetVoidStageKeyImpl(@Nullable BiFunction<Supplier<Set<X>>, KeyFunction<Void>, SetSStatsKey<X>> keyConstructor, @Nullable Supplier<Set<X>> defaultFunction, @NotNull VoidKeyFunction keyFunction) {
        super(keyConstructor, defaultFunction, keyFunction);
    }

    public SetVoidStageKeyImpl(@NotNull VoidKeyFunction keyFunction) {
        super(keyFunction);
    }
