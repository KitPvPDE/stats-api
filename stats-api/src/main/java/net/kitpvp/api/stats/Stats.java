...
public interface Stats {
    ...
    /**
     * Gets the uuid of the player associated with this instance
     *
    ...
    /**
     * Load the current {@link StatsReader} representation from the database source
     *
     * @return
     */
    StatsReader load();
    ...
    default void load(Consumer<StatsReader> callback, Executor executor) {
        Async.run(() -> {
            StatsReader statsReader = this.load();
            executor.execute(() -> {
