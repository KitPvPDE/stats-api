...
public class Ranking {
    ...
    public static <K, V extends Number> long calculateRanking(MongoStats stats, MongoStatsReader statsReader, StatsKey<K, V> statsKey, K k) {
    ...
    public static <K, V extends Number> long calculateRanking(MongoStats stats, MongoStatsReader statsReader, SeasonKey<K, V> statsKey, K k, int season) {
    ...
    public static <V extends Number> long calculateRanking(MongoStats stats, MongoStatsReader statsReader, SSeasonKey<V> statsKey, int season) {
